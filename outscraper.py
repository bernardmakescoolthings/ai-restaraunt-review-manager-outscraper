...
class Outscraper:
    ...
    def get_all_reviews(self, place_ids: list):
        """
        ...
        for place_id in place_ids:
            for attempt in range(3):
                try:
                    response  = self.client.google_maps_reviews(place_id, sort='newest', reviews_limit=10, language='en', async_request=True)
...
if __name__ == "__main__":
    logger.info("Starting Outscraper processing")
    """    place_ids = [
    'ChIJLQ0B786BhYARxEYawAudGuw', #Tasty Pot SF
    'ChIJZ8IAUdCBhYARNHkJl4-Ahyw', #Simmer Steamer SF
    'ChIJYYhsCqt_hYARSJWCIEXaFWU', #Simmer Steamer Berkeley
    ]"""

    #https://developers.google.com/maps/documentation/javascript/examples/places-placeid-finder
    place_ids = ['ChIJLQ0B786BhYARxEYawAudGuw'] #Tasty Pot SF

    # Create an Outscraper instance and save data
    outscraper = Outscraper()
    # result = outscraper.get_all_reviews(place_ids)
    result = outscraper.get_all_reviews_last_24(place_ids)
    logger.info("Finished Outscraper processing")
